...
// Get update by ID
var getUpdateById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var update;
    return __generator(this, function (_a) {
        switch (_a.label) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!match) {
                    res.status(400);
                    return [2 /*return*/, res.json({ message: "theres no updates matched this request" })];
                }
